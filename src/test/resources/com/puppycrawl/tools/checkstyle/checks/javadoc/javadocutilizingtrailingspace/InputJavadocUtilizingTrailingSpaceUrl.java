...
public class InputJavadocUtilizingTrailingSpaceUrl {
     ...
     */
    public void longUrlAtStartWithTextViolation() { }

    /**
     * https://example.com/this/is/a/very/long/url/that/exceeds/limit for more
     * details.
     */
    public void correctedLongUrlAtStartWithTextViolation() { }

    // violation 2 lines below 'Line is longer than 80 characters (found 84).'
    /**
     * https://example.com/this/is/a/very/long/url/that/exceeds/limit {@link Object}
     */
    public void longUrlAtStartWithTagViolation() { }
}
