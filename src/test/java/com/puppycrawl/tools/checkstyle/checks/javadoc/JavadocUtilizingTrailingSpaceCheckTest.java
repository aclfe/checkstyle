...
public class JavadocUtilizingTrailingSpaceCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefaultConfiguration() throws Exception {
        final String[] expected = {
            ...
            "97:7: " + getCheckMessage(MSG_TOO_LONG, 80, 85),
            "98:7: " + getCheckMessage(MSG_TOO_SHORT, 80, 12),
        };
    ...
    public void testBlockTagValues() throws Exception {
        final String[] expected = {
            "17:8: " + getCheckMessage(MSG_TOO_LONG, 80, 131),
            "42:8: " + getCheckMessage(MSG_TOO_SHORT, 80, 29),
            "75:8: " + getCheckMessage(MSG_TOO_LONG, 80, 87),
            "83:8: " + getCheckMessage(MSG_TOO_LONG, 80, 81),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCustomLimit() throws Exception {
        final String[] expected = {
            ...
            "45:8: " + getCheckMessage(MSG_TOO_LONG, 50, 60),
            "76:7: " + getCheckMessage(MSG_TOO_LONG, 50, 75),
        };
        verifyWithInlineConfigParser(
    ...
    public void testInlineLink() throws Exception {
        final String[] expected = {
            "17:8: " + getCheckMessage(MSG_TOO_LONG, 80, 116),
            "44:8: " + getCheckMessage(MSG_TOO_LONG, 80, 96),
            "50:7: " + getCheckMessage(MSG_TOO_LONG, 80, 92),
        };
        verifyWithInlineConfigParser(
    ...
    public void testOpeningLine() throws Exception {
        final String[] expected = {
            "16:8: " + getCheckMessage(MSG_TOO_SHORT, 80, 33),
            "50:7: " + getCheckMessage(MSG_TOO_LONG, 80, 85),
        };
        verifyWithInlineConfigParser(
    ...
    public void testTooLong() throws Exception {
        final String[] expected = {
            ...
            "56:8: " + getCheckMessage(MSG_TOO_LONG, 80, 124),
            "62:8: " + getCheckMessage(MSG_TOO_LONG, 80, 129),
            "70:8: " + getCheckMessage(MSG_TOO_LONG, 80, 118),
            "82:7: " + getCheckMessage(MSG_TOO_LONG, 80, 92),
        };
        verifyWithInlineConfigParser(
    ...
    public void testUrl() throws Exception {
        final String[] expected = {
            ...
            "95:7: " + getCheckMessage(MSG_TOO_LONG, 80, 87),
            "107:7: " + getCheckMessage(MSG_TOO_LONG, 80, 84),
        };
        verifyWithInlineConfigParser(
